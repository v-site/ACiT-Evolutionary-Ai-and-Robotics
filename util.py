...
def initialize_rules(windowLength):
    ...
    responseList = [0] * binaryWindow                                          # WIP genome to be generated by evo
    n = 0

    for n in range(binaryWindow):
    ...
    return dict(zip(conditionList, responseList))                              # Merges the list of rules with the list of outcomes
